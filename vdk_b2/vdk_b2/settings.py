"""
Django settings for vdk_b2 project.
...
SECRET_KEY = 'django-insecure-25@nj_k#8#j7$$_fg=mnexr4=a2ktf=qwm#c$%th**m=szynp='
...
WSGI_APPLICATION = 'vdk_b2.wsgi.application'
...
# ESP32_COMMAND_PUSH_ENABLED = False and let ESP32 poll coap://server:5683/command.
